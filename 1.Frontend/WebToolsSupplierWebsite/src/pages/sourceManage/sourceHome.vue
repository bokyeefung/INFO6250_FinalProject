<template>
    <div id="source-home-container" class="source-home-container">
        <el-card style="margin-top: 20px;" v-loading="loading">
            <div slot="header">
                <span>Overview</span>
                <el-button style="float: right;" size="small" type="primary" @click="toSourceAdd">New Raw Material</el-button>
            </div>
            ...
            <el-table :data="tableData" :resizable="false" ref="multipleTable" @selection-change="handleSelectionChange"
                ...
                <el-table-column prop="name" label="Raw Material Name" min-width="180" fixed sortable></el-table-column>
