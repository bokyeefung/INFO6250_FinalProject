...
import com.bokyeefung.webtools.webtoolsmainservice.manufacture.service.impl.AdminService;
...
@Slf4j
@Component("manufactureAdminServiceImpl")
public class AdminServiceImpl implements AdminService {
    ...
    public UserPo selectUserByUuid(String uuid) throws ServiceException {
        ...
        if (!UserEntity.MANUFACTURE.equals(userPo.getEntity())) {
