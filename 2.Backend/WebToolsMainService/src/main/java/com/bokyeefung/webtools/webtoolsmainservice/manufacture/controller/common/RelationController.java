...
package com.bokyeefung.webtools.webtoolsmainservice.manufacture.controller.common;
...
@RestController("manufactureRelationController")
@RequestMapping("/manufacture/common/relation")
