...
package com.bokyeefung.webtools.webtoolsmainservice.distributor.controller.common;
...
@RestController("distributorRelationController")
@RequestMapping("/distributor/common/relation")
